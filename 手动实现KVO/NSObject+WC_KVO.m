...
@property (nonatomic, copy) WCObservingBlock block;

@end

@implementation PGObservationInfo

- (instancetype)initWithObserver:(NSObject *)observer Key:(NSString *)key block:(WCObservingBlock)block
{
    self = [super init];
    if (self) {
        _observer = observer;
...
@implementation NSObject (WC_KVO)
