...
- (id)initWithText:(NSString *)text_ firstIn:(BOOL) a{
    if (a) {
        ...
        if (self = [super init]) {
            ...
            CGSize textSize = [text boundingRectWithSize:CGSizeMake(280, MAXFLOAT) options:NSStringDrawingTruncatesLastVisibleLine|NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:dict context:nil].size;
                            
            
            textLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 10, textSize.width + 12, textSize.height + 12)];
